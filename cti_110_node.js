...
const connectionString = `postgres://LewisBeverly:CTI_110_WakeTech@localhost/Gradebook`;
...
router.get('/', function(req, res){
    ...
    // from the same directory it's in, called lewisbeverly_gradebook.html
    res.sendFile(path.join(__dirname, 'lewisbeverly_gradebook.html'));
});
